    ...
    return (
        ...
        <section className="h-screen flex flex-col items-center text-white px-6 py-12 bg-black bg-[url('/cover4.jpg')]">
            ...
            >
                ...
                />
                <h2 className="text-2xl mb-4 mt-10 tracking-wider w-[320px] text-center" style={{ fontFamily: "var(--font-playfair)" }}>Para ayudarte a guardar un lugar especial, confirmá antes del <br /> <strong>10 de Agosto</strong></h2>
